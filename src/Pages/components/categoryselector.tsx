...
import bag from '../../assets/belt2.jpg'
import bag2 from '../../assets/rose.jpg'
import bag3 from '../../assets/dami_1.jpg'
        ...
        <p className="font-bold text-yellow-300 text-sm">N{product.price}</p>
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="bg-black text-yellow-300 px-6 py-2 rounded hover:border-2 hover:border-black hover:text-white hover:bg-white transition"
            >
              Go to Shop
            </button>
          </div>
