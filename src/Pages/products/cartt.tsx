...
const Cart: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("https://api.jsonbin.io/v3/b/680c93278a456b796691bca7/latest", {
          headers: {
            "X-Master-Key": "$2a$10$qrNF.b6EVU4HN2N8Dvegaez/mp2L7ZO9EjET5ujsIiWNSfuOyB.mu",
          },
        });
