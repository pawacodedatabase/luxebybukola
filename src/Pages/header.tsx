    ...
    <header className="bg-[#000000]  py-4 px-4 sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto  flex items-center justify-between">
          ...
          >
            ...
            >
              <motion.span
                ...
                className="absolute h-1 w-6 bg-yellow-300"
              ...
              <motion.span
                ...
                className="absolute h-1 w-4 bg-yellow-300"
                style={{
                  x: "-50%",
                  y: "50%",
                  bottom: "35%",
        ...
        <div className="hidden md:flex items-center gap-4 ">
          <Link
            to="/"
            className="relative text-[#fff] hover:text-yellow-600 transition-colors duration-300 before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-[2px] before:bg-[#2E4156] before:transition-all before:duration-300 before:ease-in-out hover:before:w-full hover:before:left-0"
          >
            Home
          </Link>
          <Link
        ...
        <div className="flex items-center space-x-2 text-xl ">
          <Link to="/wishlist" className="text-yellow-300  hover:font-bold hover:text-[#fff] transition-colors duration-300">
            <FiHeart  />
          </Link>
          <Link to="/cart" className="text-yellow-300  hover:font-bold hover:text-[#fff] transition-colors duration-300">
            <FiShoppingCart  />
          </Link>

          <Link
            to="/shop"
            className="text-yellow-300  hover:font-bold hover:text-[#fff]  transition-colors duration-300"
          >
            <FiShoppingBag/> 
          </Link>
        </div>
